$(function(){
	...
	$(document).one('click', '.comment-it', function(event){
       ...
       var comment ;
	    ...
	    $.post('http://localhost/TwitterClone-1/core/ajax/comment.php', {qoute:tweet_id,user_id:user_id,comment:comment}, function(data){
    ...
    $(document).on('click','.reply', function(){
       ...
       console.log(tweet_id);
       console.log(user_id);
        $.post('http://localhost/twitterclone/core/ajax/comment.php', {showReply:tweet_id,user_id:user_id}, function(data){
            $('.popupComment').html(data);
...
$(document).one('click', '.reply-it', function(event){
   ...
   var comment ;
    ...
    $.post('http://localhost/twitterclone/core/ajax/comment.php', {reply:comment_id,user_id:user_id,comment:comment}, function(data){
